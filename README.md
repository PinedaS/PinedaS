...
|---|---|---|
| [weather-dashboard-java](https://github.com/PinedaS/weather-dashboard-java) | Consulta de clima con WeatherAPI aplicando programación funcional (Streams) | Java 22, Maven, Gson, JUnit 5, Mockito |

## Intereses

Arquitectura de software y sistemas distribuidos. Aquí publico mis proyectos de práctica.

## Contacto

[LinkedIn](https://www.linkedin.com/in/sebastian-pineda-duque/)
